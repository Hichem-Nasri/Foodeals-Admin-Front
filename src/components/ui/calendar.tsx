  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-neutral-50 hover:bg-primary hover:text-neutral-50 focus:bg-primary focus:text-neutral-50 dark:bg-neutral-50 dark:text-primary dark:hover:bg-neutral-50 dark:hover:text-primary dark:focus:bg-neutral-50 dark:focus:text-primary",
        day_today: "bg-neutral-100 text-primary dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-neutral-100 aria-selected:text-primary dark:aria-selected:bg-neutral-800 dark:aria-selected:text-neutral-50",
