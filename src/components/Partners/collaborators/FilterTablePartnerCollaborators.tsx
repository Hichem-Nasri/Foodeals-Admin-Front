				...
				<div className="flex flex-col gap-5">
					...
					<div className="flex lg:flex-row flex-col gap-3 w-full">
						<div className="flex flex-col gap-3 w-full">
							...
							<Input name="email" onChange={() => { }} placeholder="Email" value={""} IconLeft={Mail} />
						</div>
						<div className="flex  flex-col gap-3 w-full">
							<Label label="Téléphone" htmlFor="Téléphone" />
							<Input name="Téléphone" onChange={() => { }} placeholder="Téléphone" value={""} IconLeft={PhoneCall} />
						</div>
					</div>
					<div className="flex lg:flex-row flex-col gap-3 w-full">
						<div className="flex flex-col gap-3 w-full">
					...
					<div className="flex flex-col gap-3 w-full">
						...
						<div className="flex lg:flex-row flex-col lg:items-center gap-3">
							<div className="flex items-center gap-2">
								<Checkbox name={PartnerSolutionType.MARKET_PRO} className="size-5" />
								<PartnerSolution solution={PartnerSolutionType.MARKET_PRO} className="px-4 py-3" size={20} />
							</div>
							<div className="flex items-center gap-2">
								<Checkbox name={PartnerSolutionType.MARKET_PRO} className="size-5" />
								<PartnerSolution solution={PartnerSolutionType.DLC_PRO} className="px-4 py-3" size={20} />
							</div>
							<div className="flex items-center gap-2">
								<Checkbox name={PartnerSolutionType.MARKET_PRO} className="size-5" />
								<PartnerSolution solution={PartnerSolutionType.DONATE_PRO} className="px-4 py-3" size={20} />
							</div>
						</div>
					</div>
				</div>
