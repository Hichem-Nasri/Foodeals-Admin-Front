	...
	columnHelper.accessor("id", {
		cell: (info) => (
			<ActionsMenu
				...
				menuList={[
					{
						actions: () => router.push(appRoutes.newAssociation.replace(":id", info.getValue()!)),
						icon: Eye,
						label: "Voir",
					},
					{
						actions: () => router.push(appRoutes.sieges.replace(":id", info.getValue()!)),
						icon: Store,
						label: "Sièges",
					},
				]}
...
export const siegesData: SiegesType[] = [
	{
		...
		phone: "0123456789",
		city: "Paris",
		solutions: [PartnerSolutionType.DONATE_PRO, PartnerSolutionType.DLC_PRO],
	},
	{
		id: "2",
		createAt: new Date(),
		...
		phone: "0123456789",
		city: "Paris",
		solutions: [PartnerSolutionType.MARKET_PRO, PartnerSolutionType.DLC_PRO],
	},
]
