...
export const CollaboratorDeliverySchema = z.object({
	avatar: z.string().refine((value) => !value.includes("https://via.placeholder.com/150"), {
	...
	numberId: z.number().min(4, "Le numéro d'identification doit être supérieur à 4"),
	role: z.string().min(3, "Le rôle doit contenir au moins 3 caractères"),
	phone: z
		.string()
		.min(9, "Le numéro de téléphone doit contenir au moins 9 chiffres")
		.refine((value) => /^\d+$/.test(value), "Le numéro de téléphone doit contenir au moins 9 chiffres"),
