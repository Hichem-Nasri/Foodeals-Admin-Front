...
export default async function DetailsCollaboratorPage({ params }: CollaboratorsPageProps) {
	const collaborators = await getCollaborators(params.partnerId, params.collaboratorId)
	return (
		<Layout>
